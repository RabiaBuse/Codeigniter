...
<h1>HIRKA ÜRÜNLERİMİZ</h1>
<div class="container">
    <!-- Ürün Kartları -->
    <div class="product-card">
        <img src="assets/image/hirka.jpeg" alt="Hırka">
        <h3>Knit Jumper Hırka</h3>
        <div class="price-container">
            <span class="price">600 TL</span>
        </div>
        <!-- Sepete Ekle butonu -->
    ...
    <div class="product-card">
        <img src="assets/image/hirka2.jpeg" alt="Hediyelik Bebek Seti">
        <h3>Papatya Desenli Hırka</h3>
        <div class="price-container">
            <span class="price">600 TL</span>
            <span class="old-price">1000 TL</span>
    ...
    <div class="product-card">
        <img src="assets/image/kahverengi_hırka.jpg" alt="Örgü Battaniye">
        <h3>Kahverengi Hırka</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/uzun_hırka_kahverengi.jpg" alt="Uzun Hırka">
        <h3>Kahverengi Uzun Hırka</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/uzun_hırka.jpg" alt="Uzun Hırka">
        <h3>Uzun Hırka</h3>
        <div class="price-container">
            <span class="price">300 TL</span>
        </div>
