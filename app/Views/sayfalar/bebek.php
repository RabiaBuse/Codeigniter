...
<h1>BEBEK ÜRÜNLERİMİZ</h1>
<div class="containeer">
    <!-- Ürün Kartları -->
    <div class="product-card">
        <img src="assets/image/bebek_zibini.jpeg" alt="Hırka">
        <h3>Örgü Bebek Zıbın</h3>
    ...
    <div class="product-card">
        <img src="assets/image/bebek.jpeg" alt="Hediyelik Bebek Seti">
        <h3>Örgü 3 parça bebek seti</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/hediyellik.jpeg" alt="Örgü Battaniye">
        <h3>Bebek Hediyesi Doğum Hediyesi</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/hediyellik2.jpeg" alt="Uzun Hırka">
