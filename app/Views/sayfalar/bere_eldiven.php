...
<h1>BERE VE ELDİVEN ÜRÜNLERİMİZ</h1>
<div class="container">
    <!-- Ürün Kartları -->
    <div class="product-card">
        <img src="assets/image/bere1.jpeg" alt="Hırka">
        <h3>El Örgüsü Balaklava</h3>
    ...
    <div class="product-card">
        <img src="assets/image/tilki.jpeg" alt="Hediyelik Bebek Seti">
        <h3>Tilki Figürlü Bere</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/bere2.jpeg" alt="Örgü Battaniye">
        <h3>Ressasm Bere</h3>
        <div class="price-container">
            <span class="price">250 TL</span>
        </div>
        <!-- Sepete Ekle butonu -->
        <button class="add-to-cart-btn" onclick="showMessage(this)">Sepete Ekle</button>
        <div class="cart-message">Sepete Eklendi</div>
    ...
    <div class="product-card">
        <img src="assets/image/eldiven2.jpeg" alt="Uzun Hırka">
        <h3>Yeşil Kurbağa El Örgüsü Eldiven</h3>
        <div class="price-container">
            <span class="price">400 TL</span>
            <span class="old-price">650 TL</span>
    ...
    <div class="product-card">
        <img src="assets/image/eldiven.jpeg" alt="Uzun Hırka">
        <h3>Mavi El Örgüsü Çılgın Eldiven</h3>
        <div class="price-container">
            <span class="price">400 TL</span>
        </div>
        <!-- Sepete Ekle butonu -->
