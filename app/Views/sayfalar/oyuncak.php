...
<h1>ÖRGÜ OYUNCAK ÜRÜNLERİMİZ</h1>
<div class="container">
    <!-- Ürün Kartları -->
    <div class="product-card">
        <img src="assets/image/Oyuncak_ayi.jpg" alt="Hırka">
        <h3>Oyuncak Ayı</h3>
    ...
    <div class="product-card">
        <img src="assets/image/oyuncak_tavan.jpg" alt="Hediyelik Bebek Seti">
        <h3>Oyuncak Tavşan</h3>
        <div class="price-container">
    ...
    <div class="product-card">
        <img src="assets/image/esek.jpeg" alt="Örgü Battaniye">
        <h3>Oyuncak Eşek</h3>
        <div class="price-container">
            <span class="price">1000 TL</span>
            <span class="old-price">1200 TL</span>
    ...
    <div class="product-card">
        <img src="assets/image/oyuncak_kurbik.jpeg" alt="Uzun Hırka">
        <h3>Oyuncak Kurbağa</h3>
        <div class="price-container">
            <span class="price">1200 TL</span>
        </div>
        <!-- Sepete Ekle butonu -->
        <button class="add-to-cart-btn" onclick="showMessage(this)">Sepete Ekle</button>
        <div class="cart-message">Sepete Eklendi</div>
    ...
    <div class="product-card">
        <img src="assets/image/harry_potter.jpeg" alt="Uzun Hırka">
        <h3>Oyuncak Harry Potter</h3>
        <div class="price-container">
            <span class="price">2000 TL</span>
            <span class="old-price">3000 TL</span>
